...
public class AddTickerElement extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(0, 342, Short.MAX_VALUE).addComponent(jButtonAddTickerEltCancel).addGap(18, 18, 18).addComponent(jButtonAddTickerElt)).addGroup(layout.createSequentialGroup().addComponent(jCheckBoxTickerEltShow).addGap(0, 0, Short.MAX_VALUE)).addComponent(jTextFieldTickerEltText)).addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(18, 18, 18).addComponent(jCheckBoxTickerEltShow).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(jTextFieldTickerEltText, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 25, Short.MAX_VALUE).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jButtonAddTickerElt).addComponent(jButtonAddTickerEltCancel)).addContainerGap()));
	...
	/**
	 * Edits a ticker element or adds a new ticker element to the @see
	 * LiveTicker
	 */
	private void jButtonAddTickerEltActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonAddTickerEltActionPerformed
		...
		//TODO adding a new TickerElement
		dispose();
