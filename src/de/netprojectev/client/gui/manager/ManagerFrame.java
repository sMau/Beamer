...
import de.netprojectev.client.gui.dialogs.AddCountdownDialog;
import de.netprojectev.client.gui.dialogs.AddTickerElement;
import de.netprojectev.client.gui.dialogs.EditMediaFileFrame;
...
public class ManagerFrame extends javax.swing.JFrame {
	...
	private void removeTickerElements() {
		...
		int newSelection = -1;
        if(selectedRows.length > 0) {
        	// TODO use displayLiveTickerModel for removing 
        	//liveTicker.remove(Misc.indexListToTickerElts(liveTicker, selectedRows));
