...
public class MainClientGUIWindow extends javax.swing.JFrame {
	...
	private void updateTableModels() {
		...
		/*
		 * last almost completed the adding files from hard disk via client to
		 * servers list. TODO next: add a listener to the table model -> pass it
		 * to the appropriate submodels (media and ticker) and invoke the
		 * updates from the proxy when new message is received.
		 */
	}
	...
	private void initComponents() {
		...
		jpAllMediaLayout.setHorizontalGroup(jpAllMediaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jspMediaTableContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 853, Short.MAX_VALUE));
		jpAllMediaLayout.setVerticalGroup(jpAllMediaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jpAllMediaLayout.createSequentialGroup().addComponent(jspMediaTableContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 477, Short.MAX_VALUE).addContainerGap()));
		...
		jpCustomQueueLayout.setHorizontalGroup(jpCustomQueueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jspQueueTableContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 853, Short.MAX_VALUE));
		jpCustomQueueLayout.setVerticalGroup(jpCustomQueueLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jspQueueTableContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 483, Short.MAX_VALUE));
		...
		jpLiveTickerLayout.setHorizontalGroup(jpLiveTickerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jspTickerTableContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 853, Short.MAX_VALUE));
		jpLiveTickerLayout.setVerticalGroup(jpLiveTickerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jspTickerTableContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 483, Short.MAX_VALUE));
		...
		jpButtonContainerLayout.setHorizontalGroup(jpButtonContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jpButtonContainerLayout.createSequentialGroup().addContainerGap().addComponent(jbAddFile).addGap(18, 18, 18).addComponent(jbAddThemeslide).addGap(18, 18, 18).addComponent(jbAddTickerElement).addGap(18, 18, 18).addComponent(jbEdit).addGap(18, 18, 18).addComponent(jbRemoveFromList).addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jpButtonContainerLayout.setVerticalGroup(jpButtonContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jpButtonContainerLayout.createSequentialGroup().addContainerGap().addGroup(jpButtonContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jbAddFile).addComponent(jbAddThemeslide).addComponent(jbAddTickerElement).addComponent(jbRemoveFromList).addComponent(jbEdit)).addContainerGap(61, Short.MAX_VALUE)));

		javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
		getContentPane().setLayout(layout);
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(tabbedPaneContainer).addComponent(jpButtonContainer, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addComponent(jpButtonContainer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(tabbedPaneContainer, javax.swing.GroupLayout.PREFERRED_SIZE, 512, javax.swing.GroupLayout.PREFERRED_SIZE)));
