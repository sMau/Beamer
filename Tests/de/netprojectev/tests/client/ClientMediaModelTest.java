...
public class ClientMediaModelTest {
	...
	private ClientMediaFile m1;
	private ClientMediaFile m2;
	private ClientMediaFile m3;
	private ClientMediaFile m4;

	@Before
	public void setUp() throws FileNotFoundException, IOException {
		Client client = new Client("", 0, new LoginData("", ""));
		m1 = new ClientMediaFile(new VideoFile("Vid1", new File("/home/samu")));
		m2 = new ClientMediaFile(new VideoFile("Vid2", new File("/home/samu")));
		m3 = new ClientMediaFile(new VideoFile("Vid3", new File("/home/samu")));
		m4 = new ClientMediaFile(new VideoFile("Vid4", new File("/home/samu")));
