...
import de.netprojectev.client.GUIClient;
import de.netprojectev.client.datastructures.MediaFileClient;
import de.netprojectev.client.datastructures.MediaType;
import de.netprojectev.desktop.models.AllMediaTableModel;
import de.netprojectev.desktop.models.CustomQueueTableModel;
import de.netprojectev.desktop.models.PriorityComboBoxModel;
import de.netprojectev.desktop.models.TickerTableModel;
import de.netprojectev.desktop.preferences.AddCountdownDialog;
import de.netprojectev.desktop.preferences.AddPriorityDialog;
import de.netprojectev.desktop.preferences.AddThemeDialog;
import de.netprojectev.desktop.preferences.PreferencesFrame;
import de.netprojectev.desktop.themeslide.ThemeslideCreatorFrame;
import de.netprojectev.client.datamodel.MediaModelClient;
import de.netprojectev.client.datamodel.MediaModelClient.UpdateCurrentFileListener;
import de.netprojectev.client.datamodel.PreferencesModelClient.UpdateAutoModeStateListener;
 ...
 * @author samu
 */
public class MainFrameDesktop extends javax.swing.JFrame implements GUIClient {

	/**
	 *
	 */
	private static final long serialVersionUID = -4247573311423083026L;
	private static final java.util.logging.Logger log = LoggerBuilder.createLogger(MainFrameDesktop.class);
	...
	private MediaFileClient currentSelectedMediaFile;
	 ...
	 */
	public MainFrameDesktop() throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, SecurityException, InterruptedException {
		...
		this.proxy.setServerShutdownListener(new ServerShutdownListener() {
			...
			public void serverShutdown() {
				JOptionPane.showMessageDialog(MainFrameDesktop.this, "Server was shut down. The Program is no exiting."
	...
	private void initComponents() {
		...
		jbAddFile.setIcon(new javax.swing.ImageIcon(((Object) this).getClass().getResource("/de/netprojectev/desktop/gfx/plus_2.png"))); // NOI18N
		...
		jbAddThemeslide.setIcon(new javax.swing.ImageIcon(((Object) this).getClass().getResource("/de/netprojectev/desktop/gfx/plus_2.png"))); // NOI18N
		...
		jbAddTickerElement.setIcon(new javax.swing.ImageIcon(((Object) this).getClass().getResource("/de/netprojectev/desktop/gfx/plus_2.png"))); // NOI18N
		...
		jbRemoveFromList.setIcon(new javax.swing.ImageIcon(((Object) this).getClass().getResource("/de/netprojectev/desktop/gfx/delete_2.png"))); // NOI18N
		...
		jbShowSelected.setIcon(new javax.swing.ImageIcon(((Object) this).getClass().getResource("/de/netprojectev/desktop/gfx/play.png"))); // NOI18N
		...
		jbShowNext.setIcon(new javax.swing.ImageIcon(((Object) this).getClass().getResource("/de/netprojectev/desktop/gfx/next.png"))); // NOI18N
	...
	private void jbUpdateFileDataActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jbUpdateFileDataActionPerformed
		...
		if (currentSelectedMediaFile != null) {
			MediaFileClient copyToSend = currentSelectedMediaFile.copy();
	...
	private void addTickerElement() {
		new CreateTickerElementDialog(this, true, new CreateTickerElementDialog.DialogClosedListener() {
	...
	private void startRefreshTimeLeftTimer(boolean fullsync) throws PriorityDoesNotExistException {
		...
		if (!fullsync) {
			if (mediaModel.getCurrentMediaFile() != null
                    && ((MediaFileClient) mediaModel.getCurrentMediaFile()).getType() != MediaType.Countdown
                    && ((MediaFileClient) mediaModel.getCurrentMediaFile()).getType() != MediaType.Video) {
	...
	private void updateEditorLable() throws MediaDoesNotExistException {
		...
		case 0:
			...
			if (row >= 0) {
				MediaFileClient selected = mediaModel.getValueAt(row);
		...
		case 1:
			...
			if (row >= 0) {
				MediaFileClient selected = mediaModel.getMediaFileById(mediaModel.getCustomQueue()
						.get(row));
